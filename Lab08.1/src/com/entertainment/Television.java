...
public class Television {
    ...
    private Tuner tuner = new Tuner();  // instantiated internally , not exposed (via get/setters)
    ...
    public String getCurrentChannel() {
        return tuner.getChannel();          // delegate to the tuner to get the current channel
    }
