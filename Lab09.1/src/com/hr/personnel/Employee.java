...
public abstract class Employee implements TaxPayer {
    ...
    // constructors
    public Employee() {
        super();    // gets inserted whether I type it or NOT
    }
    ...
    /*
     * We declare that all EMPLOYEES get paid but we can't implement here
     * we don't have financial data to come up with dollar figure
     */
