...
public class Department {
    ...
    public void payEmployees() {                // no pay method in Employee class so this class cannot resolve a pay method
        for (int i = 0; i < currentIndex; i++) {
            employees[i].pay();
        }
    }
    ...
    public String toString() {
        return getClass().getSimpleName() +": name=" + getName() + ", location=" + getLocation();       //retieving class name with getClass().getSimpleName() method
    }
}